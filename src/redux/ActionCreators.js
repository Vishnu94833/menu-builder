...
export const postComment = (dishId, rating, author, comment) => (dispatch) => {
    ...
    return http.post('/sobjects/Comment__c',newComment)
    .then(response => {
...
export const fetchDishes = () => (dispatch) => {
    ...
    return http.get('/query/?q=SELECT+id__c,Name__c,image__c,category__c,label__c,price__c,featured__c,description__c+from+dishes__c')
    .then(response => {
...
export const fetchComments = () => (dispatch) => {    
    return http.get('/query/?q=SELECT+id__c,dishId__c,rating__c,author__c,comment__c,date__c+from+Comment__c')
    .then(response => {
        if (response.statusText === "OK") {
          let list=[];
          response.data.records.forEach(element => {
...
export const fetchPromos = () => (dispatch) => {
    ...
    return http.get('/query/?q=SELECT+id__c,Name__c,Label__c,Price__c,Image__c,Featured__c,Description__c+from+Promotion__c')
    .then(response => {
        if (response.statusText === "OK") {
      let list=[];
      response.data.records.forEach(element => {
...
export const fetchLeaders = () => (dispatch) => {
    ...
    return http.get('/query/?q=SELECT+id__c,Name__c,Image__c,Designation__c,Abbr__c,Featured__c,Description__c+from+Leader__c')
    .then(response => {
        if (response.statusText === "OK") {
          let list=[];
          response.data.records.forEach(element => {
